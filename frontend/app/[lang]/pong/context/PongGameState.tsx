...
export const PongGameState: React.FC<{ gameMode:boolean, isBotActive: boolean, strength: number, children: ReactNode, tournament: {id: number, index: number}, setTournament: Dispatch<SetStateAction<{id: number, index: number}>>}> = ({ gameMode = false, isBotActive = false, children, strength = 0.9, tournament, setTournament }) => {
